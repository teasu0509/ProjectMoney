                    ...
                    <div class="modal-body">
                        <div class="col-md-5">
                            <td><input class="form-control" placeholder="ccc"
                                required="true" name="name" class="form-control" id="showName" value=""></td>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                 ...
                 <form modelAttribute="deleteAllIdForm" method="post" id="deleteAllIdForm">
                <input type=hidden class="form-control" placeholder="ccc"
                    required="true" name="id" class="form-control" id="deleteAllshowId" value="">
                    </form>  
                <form modelAttribute="deleteForm" method="post" id="deleteAllForm">
                    <div class="modal-body">
                        <div class="col-md-5">
                            <td><input class="form-control" placeholder="請輸入delete，並且點擊刪除"
                                required="true" name="DeleteCheck" class="form-control" id="DeleteAllCheck" value=""></td>
                        </div>
						...
						columns : [
								...
								},
								{
									...
									formatter : function(value, row, index) {
                                        ...
                                        html += "<button type='button' class='btn btn-sm btn-warning' data-toggle='modal' data-target='#ccc' data-id='"+JSON.stringify(row.id)+"' data-name='"+JSON.stringify(row.name)+"' data-description='"+JSON.stringify(row.description)+"' data-price='"+JSON.stringify(row.price)+"'><span class='glyphicon glyphicon-pencil' aria-hidden='true'/>修改</button>&nbsp;&nbsp;";
                                        html += "<button type='button' class='btn btn-sm btn-danger'  data-toggle='modal' data-target='#deleteModal' data-id='"+JSON.stringify(row.id)+"'><span class='glyphicon glyphicon-remove' aria-hidden='true'/>刪除</button>&nbsp;&nbsp;"
                                                ;
										return html;
